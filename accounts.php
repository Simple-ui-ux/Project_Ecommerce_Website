        ...
        <div class="container mt-5">
          <div class="row tm-content-row">
            <div class="col-12 tm-block-col">
              ...
              <table id="userTable" class="display table table-bordered hover">
                      <thead>
                          <th>Username</th>
                          <th>Password</th>
                          <th>Email</th>
            ...
            <div class="tm-block-col tm-col-avatar">
              <div class="tm-bg-primary-dark tm-block tm-block-avatar">
                ...
                <div class="tm-avatar-container">
                            <img class="tm-avatar img-fluid mb-4" src="<?php if(isset($img)){echo $img;} else{echo"\Project_Ecommerce_Website\images\user.png";} ?>" id="no_img">
                            <br>
